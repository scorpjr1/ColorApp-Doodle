...
public class SplashScreenFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button btnNextSC = view.findViewById(R.id.btnNextSC);
        btnNextSC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                FragmentManager fragmentManager = getFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                SplashScreenFragment1 splashScreenFragment1 = new SplashScreenFragment1();
                fragmentTransaction.replace(R.id.splashScreenFrameLayout, splashScreenFragment1);
